require 'faker'
 ...
 20.times do
   event = Event.create!(
      ...
      minimum_participants: Faker::Number.between(from = 0, to = 30),
      maximum_participants: Faker::Number.between(from = 31, to = 450),
      current_participants: Faker::Number.between(from = 3, to = 450),
...
# Create regular user
 ...
 event_for_rachel = Event.create!(
      ...
      minimum_participants: Faker::Number.between(from = 0, to = 30),
      maximum_participants: Faker::Number.between(from = 31, to = 450),
      current_participants: Faker::Number.between(from = 0, to = 450),
